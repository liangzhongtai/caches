...
public class CacheThreadProxy {
     ...
     * */
    public CacheThreadProxy(int corePoolSize, int maximumPoolSize) {
        mCorePoolSize = corePoolSize; mMaximumPoolSize = maximumPoolSize;
    }
    /**
    ...
    /** 执行任务和提交任务的区别?
     * 1.有无返回值 execute->没有返回值 submit-->有返回值
     * 2.Future的具体作用?
    ...
    public void execute(Runnable task) {
        initThreadPoolExecutor(); mExecutor.execute(task);
    }
    /** * 提交任务 */
